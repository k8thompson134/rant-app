...
RantTrack is designed to be **100% private by default**. Your symptom data never leaves your device. As the developer, I cannot see it, and the app is built so that no one—including me—can access your health information.

This is a core principle: **your health data is yours, and it stays yours.**
...
**RantTrack does not collect any data.**

This includes:
- Personal information (name, email, phone number)
- Health data (symptoms, entries, medical history)
- Usage data (frequency of use, feature interactions)
...
RantTrack does not share your data because it does not have access to your data.

### Feedback Forms

If you choose to send feedback through the in-app feedback button, you will be redirected to an external Google Form. This is:
...
- **User-controlled** (you can optionally copy device info to help with debugging)

Any information you share in feedback forms is governed by Google Forms' privacy policy, not RantTrack's.
...
I cannot access your symptom data (by design), but I'm happy to answer questions about how the app works.
...
That trust is honored by **never having access to your data in the first place.**

Local-first. Privacy-first. Always.

---

**Questions?** Email katethompson134@gmail.com or open an issue on GitHub.

**Want to verify these claims?** Review the open source code: https://github.com/k8thompson134/rant-app

---

*This privacy policy was written in plain language because legal jargon creates barriers to accessibility. If you need this policy in another format (large print, screen reader optimized, simplified language), please contact me.*
